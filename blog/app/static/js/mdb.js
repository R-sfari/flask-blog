                            ...
                            if ("scroll" === T) {
                                ...
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (O = a(r).tweensContainer), u.each(y, function(t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(E) && !W && 0 !== $ && (W = 0), c._cacheValues && O && O[E] ? (W === n && (W = O[E].endValue + O[E].unitType), N = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[E] ? W === n ? (N = b.getPropertyValue(r, z), W = b.getPropertyValue(r, E, N)) : N = b.Hooks.templates[z][1] : W === n && (W = b.getPropertyValue(r, E));
                                        var H, B, j, Y = !1;
                                        if (W = (H = f(E, W))[0], j = H[1], $ = (H = f(E, $))[0].replace(/^([+-\/*])=/, function(t, e) {
                                                return Y = e, ""
                                            }), B = H[1], W = parseFloat(W) || 0, $ = parseFloat($) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? ($ /= 100, B = "em") : /^scale/.test(E) ? ($ /= 100, B = "") : /(Red|Green|Blue)$/i.test(E) && ($ = $ / 100 * 255, B = "")), /[\/*]/.test(Y)) B = j;
                                        else if (j !== B && 0 !== W)
                                            if (0 === $) B = j;
                                            else {
                                                o = o || m();
                    ...
                    update: function(t, e, i) {
                        if (t) {
                            ...
                            var A = l,
                                ...
                                _ = u,
                                D = d;
                            n.each(h.concat(p), W), n.each(h, function(t) {
                                A += t.width
                            }), n.each(p, function(t) {
                                O += t.width
                            }), n.each(f.concat(m), W), n.each(f, function(t) {
                                _ += t.height
                            }), n.each(m, function(t) {
                                D += t.height
                            }), n.each(h.concat(p), function(t) {
                            ...
                            var $ = l + E,
                                V = u + L;
                            n.each(h.concat(f), z), $ += k, V += C, n.each(p, z), n.each(m, z), t.chartArea = {
                                left: A,
                                top: _,
                                right: A + k,
                                bottom: _ + C
                        ...
                        function z(t) {
                            t.isHorizontal() ? (t.left = t.fullWidth ? l : A, t.right = t.fullWidth ? e - c : A + k, t.top = V, t.bottom = V + t.height, V = t.bottom) : (t.left = $, t.right = $ + t.width, t.top = _, t.bottom = _ + C, $ = t.right)
                        }
                    }
                }
            }, {
                        ...
                        if (i.display) {
                            ...
                            if (a.each(g, function(n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        ...
                                        if (m) {
                                            var W = w + V;
                                            "bottom" === i.position ? ($ = f ? "middle" : "top", F = f ? "right" : "center", L = e.top + W) : ($ = f ? "middle" : "bottom", F = f ? "left" : "center", L = e.bottom - W);
                                ...
                                if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                                    ...
                                    D = F ? e.left + R + S.top : e.right - R - S.top, E = e.top + (e.bottom - e.top) / 2, L = F ? -.5 * Math.PI : .5 * Math.PI
                                }
                            ...
                            if (h.drawBorder) {
                                ...
                                m ? (W = z = "top" === i.position ? e.bottom : e.top, W += N, z += N) : ($ = V = "left" === i.position ? e.right : e.left, $ += N, V += N), o.beginPath(), o.moveTo($, W), o.lineTo(V, z), o.stroke()
                            }
                        }
                    }
                })
...
dropdownSelectors.on({
    ...
    function(t) {
        ...
        t(document).on("change", '.file-field input[type="file"]', function(e) {
            readURL(this, $(this).parents('div .file-field').find(".img-preview"));
        })
    }(jQuery),
    function(t) {
        var e, i = function() {
    ...
    function() {
        ...
        function M(t, e) {
            ...
            if (e.twelvehour)
                for (E = 0; E < 12; E += e.hourstep) L = $.clone(), R = E / 6 * Math.PI, F = b, L.css("font-size", "140%"), L.css({
                ...
                for (E = 0; E < 24; E += e.hourstep) {
                    ...
                    F = V ? x : b, L.css({
                        left: y + Math.sin(R) * F - w,
                        top: y - Math.cos(R) * F - w
                    }), V && L.css("font-size", "120%"), L.html(0 === E ? "00" : E), p.append(L), L.on(u, z)
                }
            var W = Math.max(e.minutestep, 5);
            for (E = 0; E < 60; E += W)
                for (E = 0; E < 60; E += 5) L = $.clone(), R = E / 30 * Math.PI, L.css({
            ...
            if (l.on(u, function(t) {
                ...
                var q = f("circle");
                q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), B.appendChild(Y), B.appendChild(X), B.appendChild(q), B.appendChild(j), H.appendChild(B), N.append(H), this.hand = Y, this.bg = X, this.fg = q, this.bearing = j, this.g = B, this.canvas = N
            }
            T(this.options.init)
        }
    ...
    function(t, e) {
        ...
        return function(t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, P, I, A, O, _, D, E, L, R, F, $, V, W, z, N, H, B, j, Y, X, q, U, Q, K, Z, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Kt = {
                    ...
                    init: function() {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, $ = o.detectFeatures(), _ = $.raf, D = $.caf, I = $.transform, R = $.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                            ...
                            e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= ze()) && (u = 0), a.currItem = We(u), ($.isOldIOSPhone || $.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === F && (St("initialLayout"), F = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += O ? "pswp--touch" : "pswp--notouch", c += $.animationName ? " pswp--css_animation" : "", c += $.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) Ot((i + h) * ft.x, k[i].el.style);
                            R || o.bind(a.scrollWrap, f, a), Ct("initialZoomInEnd", function() {
                                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), $.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Ft), o.bind(window, "resize scroll", a), St("bindEvents")
                    ...
                    close: function() {
                        s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ft), $.transform && o.unbind(a.scrollWrap, "click", a), j && o.unbind(window, p, a), St("unbindEvents"), Ne(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                    ...
                    updateSize: function(e) {
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, Bt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, _t(ft.x * ht), St("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Ot((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = We(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Qe(s), At(s));
                            w = !1
                        }
                ...
                Te = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!B || "mousedown" !== t.type) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            K = null, Ut(), j && 1 !== n || (j = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, St("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }], W = V = Mt(), $t(g, !0), pe(), fe()), !Z && n > 1 && !et && !Q && (v = g, X = !1, Z = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Zt, i[0]), Et(Gt, i[1]), be(Zt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Zt, Gt))
                        }
                    }
                },
                Pe = function(t) {
                    ...
                    if (K) {
                        ...
                        if (0 !== t)
                            if (Et(Zt, K[0]), Jt.x = Zt.x - te.x, Jt.y = Zt.y - te.y, Z && t > 1) {
                                ...
                                })(Mt(), Zt.x, Zt.y), q = !0, J = a.currItem.bounds, Me("x", Jt) || (Me("y", Jt), Lt(ut), It())
                            }
                    }
                },
                Ae = function(t) {
                    ...
                    var c = -1;
                    if (0 === l && (j = !1, o.unbind(window, p, a), pe(), Z ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", Z && 2 > l && (Z = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), K = null, q || X || et || H)
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        (A = $.pointerEvent) && $.touch && ($.touch = !1), A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : $.touch ? (t("touch", "start", "move", "end", "cancel"), O = !0) : t("mouse", "down", "move", "up"), p = M + " " + T + " " + P, f = S, A && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = O, m[S] = Te, m[M] = Pe, m[T] = Ae, P && (m[P] = m[T]), $.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[M], m.mouseup = m[T]), O || (r.allowPanToNext = !1)
                    }
                }
            });
            var Re, Fe, $e, Ve, We, ze, Ne = function(e, i, n, s) {
                    var l;
                    ...
                    var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
                        h = function() {
                            Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Tt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), Ve = !1
                        };
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function() {
                        o.extend(r, je, !0), a.items = Fe = i, We = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), Ct("beforeChange", function(t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], ze()),
                                s = Math.min(i[1], ze());
                    ...
                    setContent: function(t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n));
                                ...
                                if (l.loadComplete = function(i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended ? !Ve && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : $.transform && (et || Ve) ? Be.push({
                                                    item: i,
                                                    baseDiv: c,
                                                    img: i.img,
                                                    index: e,
                                ...
                                l.loading || qe(l), a.allowProgressiveImg() && (!$e && $.transform ? Be.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
            ...
            x.init = function() {
                e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    function() {
                        ...
                        C || O(), y && clearInterval(y), e.unbind(document, "mouseout", F), e.unbind(document, "mousemove", R), e.unbind(n, "pswpTap click", M), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                    }), d("destroy", function() {
